...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Sep 2025 pada 15.49
...
(5, '3201012345670005', '0816665670005', 'RSUD Kota Contoh', 'KELAS I', 'PENDING', '2024-07-01');
...
('3201012345670005', '0000000000000000', 'Rizki Pratama', 'Medan', '1993-09-05', 'L', 'Jl. Gatot Subroto No. 654, RT 005, RW 001', 'Islam', 'Cerai Hidup', 'Pegawai Negeri Sipil', 'WNI', '2025-09-30 04:18:31');
...
INSERT INTO `users` (`id`, `username`, `email`, `phone_number`, `password_hash`, `role`, `nik`, `date_of_birth`, `created_at`) VALUES
(1, 'string', NULL, NULL, 'Afs2CwzrZq2tkYi0faN7+UsTQB9/ezsQXcmSpAKBg3hIYhUVo0E2s0S9wOfgNkW4KA==', 'STRING', 'string', NULL, '2025-09-23 05:42:54'),
(2, 'test_user', NULL, NULL, 'AcPaZvcY8B8v7SlNA/Xjs8P7qPrje8qn1L/vOt84y59Focko9Fl3FNCKchBwt4lowg==', 'USER', '1234567890123456', NULL, '2025-09-23 18:23:34'),
(3, 'admin_bpjs', NULL, '08123456789', 'ATqz3H3AsWUhz28FuCvkDdJDv8EdkKKPngfJg0Su2ACM+gD6/1Qh4wiG0SJnRSnBqw==', 'ADMIN', '3201012345670001', '2015-09-02', '2025-09-23 19:04:08'),
(4, 'admin2', NULL, NULL, 'AW6NKtqWDLKflo6DV9Rf6+jWc0zN4KKe8oBc9ssZ7tnHO2lIT6Jf8J0gSd2DWgASpQ==', 'ADMIN', '3201012345670002', NULL, '2025-09-29 20:58:29'),
(5, 'user_baru', 'userbaru@example.com', '081234567890', 'AQEhPgVWBknTqiqC/QqIEUaDLb5+F7aqUBVe3thgEbEnlNK4lQKmet1rjUgJNlOimg==', 'USER', '3201012345670005', '2000-01-01', '2025-09-29 21:13:35');
...
ALTER TABLE `users`
  ...
  ADD UNIQUE KEY `ux_users_phone_number` (`phone_number`),
...
--
ALTER TABLE `bpjs`
  MODIFY `id_bpjs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
